...
export class ConversationalActionRequest implements JovoRequest {
  ...
  hasAudioInterface(): boolean {
    if (this.device) {
      return !!this.device.capabilities.find((cap: Capability) => cap === 'SPEECH' || cap === 'LONG_FORM_AUDIO');
    }
    return false;
  }
  ...
  isNewSession(): boolean {
    return _get(this, 'session.params._JOVO_SESSION_') === true;
  }
  ...
  setNewSession(isNew: boolean): this { // TODO:
    return this;
  }
